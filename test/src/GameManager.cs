...
namespace GowtuApp
{
    public class GameManager : GameBehaviour
    {
        ...
        private void SetupGrass()
        {
            ...
            grass.name = "Grass";
            batchRenderer = grass.AddComponent<BatchRenderer>();
            batchRenderer.SetMesh(MeshGenerator.CreateQuad(Vector3.One));
            var material = new DiffuseInstancedMaterial();
            material.DiffuseTexture = Resources.FindTexture<Texture2D>("Resources/Textures/billboardgrass0002.png");
            batchRenderer.SetMaterial(material);
            batchRenderer.InstanceCount = 50000;
        ...
        private void OnGUI()
        {
            ...
            if(GUI.BeginWindow("Light", new System.Numerics.Vector2(128, 32)))
            {
